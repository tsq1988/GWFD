...
// ============================================================================================== //
    ...
    int AcceZ = ((fifoBuffer[36] << 8) + fifoBuffer[37]);
       ...
       # endif
      systime=micros();
   Serial.print  (systime,DEC); Serial.print("\t");
   

    #ifdef OUTPUT_RAW_ACCEL_G
      // same as OUTPUT_RAW_ACCEL but recalculated to g-force values
      Serial.print  (AcceX, HEX); Serial.print("\t");
      Serial.print  (AcceY, HEX); Serial.print("\t");
      Serial.print  (AcceZ, HEX); Serial.print("\t");
    #endif
     ...
     // Serial.print("Quaternion qw, qx, qy, qz [-1 to +1]: "); Serial.print("\t");
      Serial.print  (raw_q_w,HEX); Serial.print("\t");
      Serial.print  (raw_q_x,HEX); Serial.print("\t");
      Serial.print  (raw_q_y,HEX); Serial.print("\t");
      Serial.print  (raw_q_z,HEX);Serial.println();
    #endif
